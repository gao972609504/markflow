...
const shortcuts: Shortcut[] = [
  ...
  { keys: 'F5', action: '选区行排序', category: '行操作' },
  { keys: 'F6', action: '选区行反转', category: '行操作' },
  { keys: 'F7', action: '选区行去重', category: '行操作' },
  { keys: 'F8', action: '选区行编号', category: '行操作' },
  { keys: 'Ctrl+Shift+U', action: '选区转大写', category: '格式' },
  { keys: 'Ctrl+Shift+L', action: '选区转小写', category: '格式' },
  { keys: 'Ctrl+]', action: '缩进列表项', category: '编辑' },
  { keys: 'Ctrl+[', action: '反缩进列表项', category: '编辑' },
  { keys: 'Ctrl+1/2/3/4', action: '折叠到标题级别', category: '折叠' },
  { keys: 'Ctrl+Shift+1', action: '展开所有折叠', category: '折叠' },
  { keys: 'Ctrl+Shift+[', action: '提升标题级别', category: '格式' },
  { keys: 'Ctrl+Shift+]', action: '降低标题级别', category: '格式' },
  { keys: 'Ctrl+F2', action: '切换书签', category: '导航' },
  { keys: 'F2', action: '下一个书签', category: '导航' },
  { keys: 'Shift+F2', action: '上一个书签', category: '导航' },
